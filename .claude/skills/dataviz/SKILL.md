---
name: dataviz
description: Use this skill whenever creating ANY chart, graph, plot, dashboard, or data visualization, in ANY output medium (Svelte/layerchart components, HTML, SVG, d3, plotting libraries, images). Read it BEFORE writing the first line of chart code, choosing chart colors, or laying out a dashboard. Covers chart-form choice, color rules with a runnable validator, mark specs, interaction rules, and stacked-bar best practices.
---
...
| `references/stacked-bars.md` | **Stacked column/bar decisions** — when to stack, segment order, labeling |
