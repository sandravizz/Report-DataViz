        ...
        >
          {#each sections as section (section.id)}
            <li class="group/chapter flex flex-col">
              ...
              >
                <span
                  class="mt-0.5 block h-2.5 w-2.5 shrink-0 rounded-full border-[1.5px] border-base-content/35 bg-transparent transition-all duration-200 group-hover/chapter:border-primary group-hover/chapter:bg-accent group-hover/chapter:ring-4 group-hover/chapter:ring-accent/30"
                ></span>
                <span
