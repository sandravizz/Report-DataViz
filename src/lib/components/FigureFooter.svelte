...
<a
  ...
  target="_blank"
  rel="noopener"
  class="-mt-1 inline-block cursor-pointer self-start font-sans text-[11px] tracking-wide text-base-content/50 underline decoration-accent decoration-2 underline-offset-[3px]"
>
  sandraviz.com
</a>
