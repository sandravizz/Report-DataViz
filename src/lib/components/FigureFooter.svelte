...
<a
  ...
  target="_blank"
  rel="noopener"
  class="-ml-2.5 inline-block md:-mt-2 self-start px-2.5 py-1 font-sans text-[11px] tracking-wide text-base-content/65 underline decoration-accent decoration-1 underline-offset-[3px]"
>
  sandraviz.com
</a>
