...
<a
  ...
  target="_blank"
  rel="noopener"
  class="-mt-2 -ml-2.5 inline-block self-start rounded-full px-2.5 py-1 font-sans text-[11px] tracking-wide text-base-content/50 underline decoration-accent decoration-1 underline-offset-[3px] transition-[background-color,box-shadow] duration-200 hover:bg-white hover:shadow-lg"
>
  sandraviz.com
</a>
