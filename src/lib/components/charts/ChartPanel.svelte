<script>
  ...
  // main only has bar-horizontal and line figures today; a future report
  // with grouped/stacked bars or line-multiples would add those imports and
  // branches here the same way template does.
