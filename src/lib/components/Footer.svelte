  ...
  >
    <div class="w-full max-w-2xl px-6 py-12 text-center sm:px-10 sm:py-16">
      ...
      <a
        ...
        >Kontakt aufnehmen →</a
      >
      <!-- The glyphs take the accent, not `text-neutral`: at #6f6f6f they read
           as disabled sitting directly under the accent-underlined contact
           link, which is the one thing on this block they are meant to belong
           with. Hover goes to primary — on this light ground the accent is
           already the bright end, so the press-down is the darker navy. -->
      <div class="mt-4 flex items-center justify-center gap-5 sm:mt-6">
        <a
          ...
          aria-label="GitHub"
          class="text-accent transition-colors duration-200 hover:text-primary"
        >
