...
// Dashed vertical reference line (e.g. an index's base period). Muted like
// axis ticks since it's a reference mark, not a data callout; spans the full
// plot height unless y1/y2 shorten it.
