...
export default {
  ...
  description:
    "In the Sustainable Convergence scenario, annual labour hours decline from about 2,100 to 1,000 hours globally between 2025 and 2100 so as to reduce material production and consumption. Annual hours around 3,000 ≈ 60 hours per week all year long; <mark class=\"accent-mark\">around 1,000 ≈ 25 hours per week during 40 weeks (12 weeks in paid vacation)</mark>.",
