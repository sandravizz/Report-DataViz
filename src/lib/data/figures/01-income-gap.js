...
export default {
  ...
  valuePrefix: "€",
  data: [
    { region: "Sub-Saharan Africa", v: 290, color: colors.vermilion },
    ...
    { region: "World", v: 1410, color: colors.purple },
    ...
    { region: "North America/Oceania", v: 4590, color: colors.vermilion },
    { region: "All Countries in 2100", v: 5000, color: colors.aqua },
  ],
};
