...
This edition presents *[Ensuring a Skilled Renewable Energy and Energy Efficiency Workforce](https://www.iea.org/reports/ensuring-a-skilled-renewable-energy-and-energy-efficiency-workforce)* (June 2026, CC BY 4.0) by the IEA — employment trends, skills needs, and gaps across renewables, grids, and energy efficiency. Client-facing notes — the IEA brand derivation — live in `docs/`.

This report is built with my interactive-report template; the template itself (tech stack, project structure, how to add chapters and figures) is documented in the README on the `main` branch.
