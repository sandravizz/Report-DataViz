...
construction, and no tint of a colour can contrast with that colour. Measured:
`#0FFF95` on the resting tint over white is **1.24:1**. Deepening the tint makes
it worse, not better (1.13:1 at 40%), because the ground climbs toward the
glyph. Every combination is invisible.

The accent here is a very light green — 1.3:1 on white — which is exactly what
...
offset, cut for 20px body copy. Both numbers are absolute rather than em-based
